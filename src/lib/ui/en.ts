...
export const en: UiCopy = {
  ...
  crm: {
    ...
    reasonsLong: {
      handoff: "The bot handed this conversation to you",
      approval: "A request is waiting for your approval",
      reminder: "A reminder you set",
      cold: "The lead stopped replying",
    },
    cta: {
    ...
    revived: "Came back",
    snooze: "Snooze",
    snooze1: "Tomorrow morning",
    snooze3: "In 3 days",
    snooze7: "In a week",
    snoozed: "Snoozed until {when}",
    nextStep: "Next step",
    noNextStep: "No next step.",
    nextPresets: ["Tomorrow 9:00", "In 3 days", "Next week"],
    nextPlaceholder: "What happens next?",
    markDone: "Done",
    nextSaved: "Next step saved",
    markedDone: "Marked done",
    notes: "Internal notes",
    notesHint: "Only your team sees these",
    addNote: "Add a note…",
    saveNote: "Save",
    saveHint: "⌘/Ctrl + Enter",
    pin: "Pin",
    ...
    tabsLead: { chat: "Conversation", activity: "Activity", details: "Details" },
    timelineFilters: { all: "All", notes: "Notes", stages: "Stages", requests: "Requests" },
    timeline: {
      stageAuto: 'Stage set to "{stage}"',
      stageManual: '{actor} set the stage to "{stage}"',
      note: "{actor} added a note",
      nextSet: "{actor} set the next step",
      nextDone: "{actor} marked the next step done",
      snooze: "{actor} snoozed until {when}",
      requestCreated: "Request created",
      requestApprove: "{actor} approved the request",
      requestDecline: "{actor} declined the request",
      requestReschedule: "{actor} offered another time",
      handoffOpened: "The bot handed the conversation to you",
      handoffResolved: "Handoff resolved",
      convoStarted: "Conversation started",
      convoEnded: "Conversation ended",
      revived: "The lead wrote again",
      today: "Today",
      yesterday: "Yesterday",
    },
    lostReasons: ["Price", "Dates", "Went elsewhere", "No reply", "Other"],
    notRelevantReasons: ["Wrong service", "Wrong area", "Job seeker", "Spam", "Supplier", "Other"],
    reasonPrompt: "Why? (optional)",
    stageSet: 'Stage set to "{stage}"',
    undo: "Undo",
